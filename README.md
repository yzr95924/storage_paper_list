...
2. *LMCache: An Efficient KV Cache Layer for Enterprise-Scale LLM Inference*----arXiv'25 ([link](https://arxiv.org/pdf/2510.09665?))
3. *An I/O Characterizing Study of Offloading LLM Models and KV Caches to NVMe SSD*----CHEOPS@EuroSys'25 ([link](https://dl.acm.org/doi/pdf/10.1145/3719330.3721230))
4. *CacheBlend: Fast Large Language Model Serving for RAG withCached Knowledge Fusion*----EuroSys'25 ([link](https://dl.acm.org/doi/pdf/10.1145/3689031.3696098))
5. *Mooncake: Trading More Storage for Less Computation - A KVCache-centric Architecture for Serving LLM Chatbot*---FAST'25 ([link](https://www.usenix.org/system/files/fast25-qin.pdf))
